/*
    ...
    Updated 2020 Weston Industries
  ...
  Nextion HMI Screen: NX4832T035_011
  Makerbase: MKS TMC2160-OC V1.0
  Aluminum Electrolytic Capacitor: 1µF 50V Aluminum Electrolytic Capacitors Radial
  Input Connector: military style barrel connector
  Output Connector: miltary style barrel connector
  Power: 24v 10Amp DC barrel jack
  Power: 24v to 5v converter
  PC diagnostic: USB A - USB B
  ...
  https://github.com/weston-Industries/TorchHeightController
  http://hdt.xyz
